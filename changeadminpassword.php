...
$dbselect=mysql_select_db("membership", $connect);
if(!$dbselect){
...
if(mysql_num_rows($result)==1){
    ...
    if($newpass!=$confirmpass){
         ...
         echo"<meta content='4';><p class='wrong'>New password and Confirm Password Not Match</p>";                                
      
       }
       elseif($newpass==$oldpass){

         echo"<meta content='4';><p class='wrong'>password is still that you were used.</p>";                                
       
       }
       else
       {
  $query="update admin set password='{$newpass}', repass='{$confirmpass}' where password='{$oldpass}'";
        $result=mysql_query($query);
     echo'  <p class="success"> Your password has been changed successfuly!</p>';
     echo' <meta content="7;changeadminpassword.php" http-equiv="refresh" />';  
   }
   }
...

{
 ...
 echo' <meta content="5;changeadminpassword.php" http-equiv="refresh" />';
}
}
?>
...
<div id="input">
<div class="group">
<input type="password"  name="old_password" minlength="2" maxlength="30" required >
...
<div id="input">
<div class="group">
<input type="password" name="new_password" minlength="2" maxlength="30" required>
...
<div id="input">
<div class="group">
<input type="password" name="confirm_password" minlength="2" maxlength="30" required>
...
</td></div></td></tr></table></div></td></tr></table></form></div>
